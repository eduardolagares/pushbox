class SendingNotificationJob < ApplicationJob
    ...
    ActiveRecord::Base.transaction do
      ...
      case notification.destiny.class.name
        ...
        when 'Topic'
          ...
          raise NotImplementError, "SendingNotificationJob can't delivery notifications for a #{notification.destiny.class.name} destiny."
      end
    end
  end
  ...
  def run_again_at(at)
    self.class.set(wait_until: at).perform_later(notification_id: self.notification_id)
  end
end
